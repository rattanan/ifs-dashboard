...
| 3. Dashboard Validation | สัปดาห์ 3–4 | ทดสอบ 60 metrics, เทียบตัวเลขกับ IFS, tuning query และ filter | Dashboard baseline report และ defect list |
...
- [ ] 60 metrics ผ่าน baseline/UAT หรือมี waiver ที่ลงนาม
